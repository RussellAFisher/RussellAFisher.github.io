$(document).ready(function() {
    ...
    $(".save").click(function(event) {
        ...
        if (earthDate === "") {
            $.get("https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol=" + marsDate + "&camera=" + cameraAngle + "&api_key=jjDQTKMMZ6ZDIONMJ5ceRMBV1Tr8J1vfgSOaPiXo").done(function(data) {
            ...
            $.get("https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?earth_date=" + earthDate + "&camera=" + cameraAngle + "&api_key=jjDQTKMMZ6ZDIONMJ5ceRMBV1Tr8J1vfgSOaPiXo").done(function(data) {
                console.log(data);
                roverArray = (data.photos);
                if (arrayIndex >= roverArray.length) {
                    $('#imgPlace').append("<br><br><br><br><br><br><br><h3>Sorry, that's all the images for<br> this camera angle on this day.<br> Try a different angle or change the date.</h3>");
